...
- ### :x:  task-kde-desktop  -- [KDE Desktop Umgebung](../common_package-lists/task-kde-desktop.md)
...
- ### :x:  staging-2018  -- [Freestyle Paketliste](../common_package-lists/staging-2018.md)
