...
- :x:  pulseaudio  -- Sound-Server PulseAudio
- :x:  pulseaudio-utils  -- Befehlszeilenwerkzeuge für den Soundserver PulseAudio 
- :x:  sound-theme-freedesktop  -- Sound-Theme von freedesktop.org
