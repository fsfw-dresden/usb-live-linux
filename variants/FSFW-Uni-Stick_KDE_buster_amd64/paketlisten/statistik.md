...
- :+1: :x:  [r-studio](https://download1.rstudio.org/desktop/bionic/amd64/rstudio-1.2.5033-amd64.deb)  -- Frontend für R (Wunsch des FSR Psychologie)
- :o:  libclang-dev  -- Clang-Bibliothek - Enwicklungspaket - wird von r-studio benötigt
