= Features, features, build variants.. 🚧 as of 2023-09-29
:table-caption!:
...
digraph build_variants {
  ...
  "FSFW-Schulstick:bullseye" -> "Basisstick:Xfce:bullseye" [ xlabel = "based on" ];
