= Features, features, build variants.. 🚧 as of 2024-03-11
:table-caption!:
...
|link:https://github.com/fsfw-dresden/usb-live-linux/tree/master/variants.build/Basisstick:Xfce:bullseye/features/workaround_chromium-l10n-security[workaround_chromium-l10n-security]	| 	| 	|✔!	| 	| 	| 	| 	| 	| 	| 	| 	| 	| 	|
