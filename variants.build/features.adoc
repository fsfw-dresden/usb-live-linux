= Features, features, build variants.. 🚧 as of 2022-02-11
:table-caption!:
...
|link:https://github.com/fsfw-dresden/usb-live-linux/tree/master/features/workaround_f2fs-tools_1.14.0_broken_persistence_resize[workaround_f2fs-tools_1.14.0_broken_persistence_resize]	| 	|✔	| 	| 	| 	| 	| 	| 	| 	| 	| 	| 	| 	|
