...
#  DESCRIPTION: bringt das live-image.iso (vorzugsweise FSFW-UNI-Stick_${FSFW_UNI_STICK_VERSION}_*.iso) auf einen USB-Stick
#               bootet mit grub2 -
#
#      VERSION: 0.0.4
...
#      CREATED: 2016-09-15
#     REVISION: 2016-11-01 - 2019-11-04
...
LIVE_IMAGE=$2
LIST_LIVE_IMAGES=($(ls ../images/FSFW-Uni-Stick_*.iso))
  ...
  Partition Persistence: $(( ${rel_size_persistence_daten} * ${size_device} / 100)) MB. \n " 0 0
            ...
            if [[ $? -eq 0 ]]; then
                ...
                if [[ ${p_windows_daten} -eq 0 ]] && [[ ${rel_size_windows_daten} -gt 0 ]]; then
                    ...
                    echo " Windows-Daten-Partition ${current_partition} - ${LABEL_WINDOWS_DATEN} angelegt "
